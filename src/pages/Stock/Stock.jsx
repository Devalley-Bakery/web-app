...
export default function Stock() {
  ...
  const [items] = useState([
    ...
    { id: 9, name: 'Calzone de Calabresa', price: 17.0, img: 'https://th.bing.com/th/id/OIP.FJ-NQ4yUxTBYRLe5Gg3aZAHaE8?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
    { id: 10, name: 'Calzone de Frango', price: 17.0, img: 'https://th.bing.com/th/id/R.3b12eb7a9223fae99096dda9f8afa0a6?rik=IjSyclQs4PPF5A&pid=ImgRaw&r=0', quantity: 0, category: 'Salgados' },
    { id:11, name: 'Coxinha', price: 5.0, img: 'https://th.bing.com/th/id/R.cfcb5ea0795015c875429cdded3550fa?rik=jvR%2b9PjPKQFk8A&pid=ImgRaw&r=0', quantity: 0, category: 'Salgados' },
    { id: 12, name: 'Empada de Frango', price: 8.0, img: 'https://th.bing.com/th/id/OIP.vY0QQZBCt_UtiEevZ52QgwHaFJ?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
    { id: 13, name: 'Empada de Frango', price: 8.0, img: 'https://th.bing.com/th/id/OIP.vY0QQZBCt_UtiEevZ52QgwHaFJ?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
    { id: 14, name: 'Empada de Frango', price: 8.0, img: 'https://th.bing.com/th/id/OIP.vY0QQZBCt_UtiEevZ52QgwHaFJ?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
    { id: 15, name: 'Empada de Frango', price: 8.0, img: 'https://th.bing.com/th/id/OIP.vY0QQZBCt_UtiEevZ52QgwHaFJ?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
    { id: 16, name: 'Empada de Frango', price: 8.0, img: 'https://th.bing.com/th/id/OIP.vY0QQZBCt_UtiEevZ52QgwHaFJ?rs=1&pid=ImgDetMain', quantity: 0, category: 'Salgados' },
  ...
  return (
    <Container sx={classe.container}>
      ...
      <Grid2 container spacing={1} sx={{ display: 'flex', flexGrow: 1, justifyContent: 'center', alignItems: 'center' }}>
